    ...
    if ( wsp_mcp_is_enabled( 'wsp/create-page' ) ) {
        wp_register_ability( 'wsp/create-page', array_merge( $base, array(
            ...
            'input_schema'       => array( 'type' => 'object', 'required' => array( 'title', 'content' ), 'properties' => array(
                ...
                'page_layout' => array( 'type' => 'string',  'description' => 'Page template/layout. Options: default | elementor_header_footer (Elementor Full Width) | elementor_canvas (Elementor Canvas, no header/footer).' ),
            ) ),

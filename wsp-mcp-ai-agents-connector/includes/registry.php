...
function wsp_mcp_ability_registry() {
    $abilities = array(
        ...
        'wsp/install-plugin'  => array( 'label' => 'Install Plugin',  'description' => 'Install a plugin from the WordPress.org plugin repository by slug, optionally activating it.', 'group' => 'Site', 'access' => 'write', 'default' => false ),
        // MENUS
